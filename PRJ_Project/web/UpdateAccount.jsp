...
<c:if test="${task == 'update' || task =='add'}">
    <form action="UpdateAccount" method="post">
        <div style="text-align: center;font-size: 0.7em;">
            UserName:<input style="border: pink;font-size: 0.7em;" type="text"value="${account.getUsername()}" name="user"
                            ${task=='update'? "readonly":""}></td>
            <br>
            <br>
            Password:<input style="border: pink;font-size: 0.7em;" type="text" value="${account.getPassword()}" name="pass">
            <br>
            <br>
            <select style="border: pink;font-size: 0.7em;" name="isManager">
