...
public class MyFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        for (int i = 0; i < urlNeedLogin.length; i++) {
            if(url.endsWith(urlNeedLogin[i]) && session.getAttribute("acc")==null){
                check1=false;
                break;
            }
        }
        String[] urlNotNeedHomePage = {"Home","Reservation.jsp","Login.jsp", "Menu","Reservation", "SpecialDishes"};
        for (int i = 0; i < urlNotNeedHomePage.length; i++) {
            if(url.endsWith(urlNotNeedHomePage[i])  ){
                check2=false;
                break;
            }
        }
        ...
        }else if( url.endsWith(".jsp") && check2 && session.getAttribute("acc")==null ){
